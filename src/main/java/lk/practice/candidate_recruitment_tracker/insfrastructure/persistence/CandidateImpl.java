...
import lk.practice.candidate_recruitment_tracker.insfrastructure.persistence.persistenceMappers.CandidatePersistenceMapper;
...
public class CandidateImpl implements CandidateRepository {
    ...
    public List<Candidate> getAllCandidates(int page, int size){
        //get all candidates
        Page<CandidateEntity> entityPage = jpaCandidateRepository.findAll(PageRequest.of(page, size));
